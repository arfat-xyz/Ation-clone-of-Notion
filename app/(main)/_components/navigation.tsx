  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    if (sidebarRef.current && navbarRef.current) {
      ...
      !!navbarRef.current.style.left
        ? (navbarRef.current.style.left = newWidth - 30 + "px")
        : navbarRef.current.style.setProperty("left", `${newWidth}px - 30px`);
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "group/sidebar h-full bg-secondary overflow-y-auto relative flex w-60 flex-col z-[99990]",
